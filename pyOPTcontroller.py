...
# dll = ctypes.cdll.LoadLibrary( r'OPTControllerSDK_V 1.0.15\x64\OPTController.dll' )
# sBuf = '192.168.1.16'.encode('utf-8')
# p = ctypes.create_string_buffer(1024)
# handle = ctypes.c_longlong(0)
# OPTController_CreateEthernetConnectionByIP = dll.OPTController_CreateEthernetConnectionByIP
# resp = OPTController_CreateEthernetConnectionByIP(sBuf, ctypes.byref(handle))

# OPTController_GetVersion = dll.OPTController_GetVersion
# p = ctypes.create_string_buffer(100)
# resp = OPTController_GetVersion(p)
# print(p.value)


# OPTController_TurnOnChannel = dll.OPTController_TurnOnChannel
# resp = OPTController_TurnOnChannel(handle, 1)
# print (resp)

# OPTController_DestroyEthernetConnection = dll.OPTController_DestroyEthernetConnection
# resp = OPTController_DestroyEthernetConnection(handle)
...
class OPTController:
    def __init__(self, dll_type='x64'):
        ...
        self.dll = ctypes.cdll.LoadLibrary( f'OPTControllerSDK\{dll_type}\OPTController.dll' )
        if dll_type == 'x64':
